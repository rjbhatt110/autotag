<template>
  <div class="w-full flex min-h-screen">
                    ...
                    >
                      ...
                      <DisclosurePanel class="space-y-1">
                        <DisclosureButton
                          ...
                          as="a"
                          :href="subItem.href"
                          class="group w-full flex items-center pl-11 pr-2 py-2 text-base font-medium text-gray-600 rounded-md hover:text-gray-900 hover:bg-gray-50"
                        >
                          {{ subItem.name }}
                        </DisclosureButton>
                      </DisclosurePanel>
          ...
          >
            <template v-for="item in navigation" :key="item.name">
              ...
              <Disclosure as="div" v-else class="space-y-1" v-slot="{ open }">
                ...
                <DisclosurePanel
                  class="space-y-1"
                  :class="[!collapse ? 'sr-only duration-500' : '']"
                >
                  <DisclosureButton
                    v-for="subItem in item.children"
                    :key="subItem.name"
    ...
    <div
      :class="[
        collapse ? 'duration-500' : 'duration-500',
              ...
              <form action="#" method="POST">
                <div class="py-10 space-y-6">
                  ...
                  <div class="grid grid-cols-3 gap-3">
                    <!-- Subject -->
                    <div
                      class="lg:flex items-baseline justify-between col-span-6 sm:col-span-3"
                    >
                      ...
                      <input
                        ...
                        value="Autotag node"
                        class="mt-1 lg:ml-1.5 block flex-[4] w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                      />
                    </div>
                    <!-- Company -->
                    <div
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm flex-1">
                          ...
                          >
                            ...
                            >
                              ...
                              ></path>
                              <path fill="#9FA8DA" d="M6 42H42V44H6z"></path>
                              <path fill="#BF360C" d="M20 35H28V44H20z"></path>
                              <path
                                fill="#1565C0"
                    ...
                    >
                      ...
                      <select
                        ...
                        class="mt-1 lg:ml-1 flex-[4] block w-full bg-white border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                      >
                        <option>Low</option>
                    ...
                    >
                      ...
                      <input
                        type="number"
                        class="form-control flex-[4] lg:ml-1 block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                        id="estimate"
                        value="0"
                      />
                    </div>
                    ...
                    >
                      <div class="flex flex-1 items-baseline">
                        ...
                        >
                          ...
                          ></path>
                          <path fill="#2196f3" d="M8.5 12H39.5V14H8.5z"></path>
                          <path
                            fill="#2196f3"
                      ...
                      <input
                        type="text"
                        class="form-control lg:ml-1.5 flex-[4] block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-gray-100 bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
